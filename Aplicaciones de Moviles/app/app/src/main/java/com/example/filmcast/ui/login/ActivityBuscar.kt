...
class ActivityBuscar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val edades =
            arrayOf("Selecciona edad", "Menos de 20", "20-30", "31-40", "41-50", "Más de 50")
        val generosCine =
            arrayOf("Selecciona género", "Acción", "Drama", "Comedia", "Terror", "Ciencia ficción")
        val educaciones =
            arrayOf("Selecciona nivel educativo", "Primaria", "Secundaria", "Universidad")
        val salarios =
            arrayOf("Selecciona salario", "Menos de 1000", "1000-2000", "2001-3000", "Más de 3000")
        val añosAct =
            arrayOf("Selecciona años de actividad", "Menos de 1", "1-5", "6-10", "Más de 10")
        ...
        val seguidores = arrayOf(
            "Selecciona # seguidores",
            "0–1000",
            "1001–8000",
            "8001–12.000",
            "12.001–18.000",
        ...
        val nacionalidades =
            arrayOf("Selecciona nacionalidad", "Colombiana", "Mexicana", "Argentina", "Otro")
        ...
        val adapterGeneroCine =
            ArrayAdapter(this, android.R.layout.simple_spinner_item, generosCine)
        ...
        val adapterTamañoPagina =
            ArrayAdapter(this, android.R.layout.simple_spinner_item, tamañosPagina)
